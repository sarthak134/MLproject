    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            models = {
                ...
                "Deciion tree": DecisionTreeRegressor(),
                "Gradinet descent": GradientBoostingRegressor(),
                "Linear Regression": LinearRegression(),
                "K-neighor classifer": KNeighborsRegressor(),
                "XGBClassfier": XGBRegressor(),
                "CatBoosting Classifer ": CatBoostRegressor(),
